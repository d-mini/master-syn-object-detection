...
from helpers import enable_physics, clean_up, load_targets, set_basic_light, random_material, load_materials
...
OUTPUT_DIR = f"../output/scenario{args.scenario}/dr_mat/inst{args.inst_per_class}_seed{args.seed}"
